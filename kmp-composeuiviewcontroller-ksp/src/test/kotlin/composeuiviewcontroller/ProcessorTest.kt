...
class ProcessorTest {
    ...
    fun `When frameworkBaseName is provided via ModulesJson it overrides @ComposeUIViewController frameworkBaseName value`() {
        tempArgs.writeText("""[{"name":"module-test","packageNames":["com.mycomposable.test"],"frameworkBaseName":"ComposablesFramework",
            |"swiftExportEnabled":false,"flattenPackageConfigured":false}]""".trimMargin())
        val code = """
            package com.mycomposable.test
    ...
    fun `Empty frameworkBaseName in ModulesJson falls back to frameworkBaseName in @ComposeUIViewController`() {
        tempArgs.writeText("""[{"name":"module-test","packageNames":["com.mycomposable.test"],"frameworkBaseName":"","swiftExportEnabled":false, 
            |"flattenPackageConfigured":false
            |}]""".trimMargin())
        val code = """
            package com.mycomposable.test
            import $composeUIViewControllerAnnotationName
